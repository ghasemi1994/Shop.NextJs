  ...
  return (
    <>
      ...
      <div className="d-flex flex-nowrap py-3 py-5-lg pr-0 jc-stretch overflow-hidden pos-relative mt-4 mt-6-lg radius-large-lg">
        <div className={`swiper-container swiper-container-initialized swiper-container-horizontal swiper-container-pointer-events swiper-container-free-mode swiper-container-rtl ${styles.widget_amazing_mini_carousel}`}>
          <Swiper
            loop={true}
            autoHeight={true}
            slidesPerView={7}
